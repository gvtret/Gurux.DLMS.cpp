...
public:
    ...
    int ImportCertificate(CGXDLMSClient *client, CGXx509Certificate &certificate, std::vector<CGXByteBuffer> &reply);
    ...
    int Activate(CGXDLMSClient *client, DLMS_SECURITY security, std::vector<CGXByteBuffer> &reply);
    ...
    * Returns Error code.
    */
    int GenerateKeyPair(CGXDLMSSecureClient *client, DLMS_CERTIFICATE_TYPE type, std::vector<CGXByteBuffer> &reply);
    ...
    * Returns Error code.
    */
    int GenerateCertificate(CGXDLMSSecureClient *client, DLMS_CERTIFICATE_TYPE type, std::vector<CGXByteBuffer> &reply);
};
