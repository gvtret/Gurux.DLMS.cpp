...
//Constructor.
CGXDLMSSFSKActiveInitiator::CGXDLMSSFSKActiveInitiator(): CGXDLMSSFSKActiveInitiator("0.0.26.1.0.255", 0) {
}
...
//LN Constructor.
CGXDLMSSFSKActiveInitiator::CGXDLMSSFSKActiveInitiator(std::string ln): CGXDLMSSFSKActiveInitiator(ln, 0) {
}
...
int CGXDLMSSFSKActiveInitiator::GetValue(CGXDLMSSettings &settings, CGXDLMSValueEventArg &e) {
    ...
    if (e.GetIndex() == 1) {
        ...
        CGXByteBuffer bb;
        if ((ret = bb.SetUInt8(DLMS_DATA_TYPE_STRUCTURE)) == 0 && (ret = bb.SetUInt8(3)) == 0 &&
