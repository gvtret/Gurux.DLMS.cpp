...
//Constructor.
CGXDLMSLimiter::CGXDLMSLimiter(): CGXDLMSLimiter("", 0) {
}

//SN Constructor.
CGXDLMSLimiter::CGXDLMSLimiter(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_LIMITER, ln, sn) {
