...
//Constructor.
CGXDLMSData::CGXDLMSData(): CGXDLMSData("", 0) {
}

//SN Constructor.
CGXDLMSData::CGXDLMSData(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_DATA, ln, sn) {
}

//LN Constructor.
CGXDLMSData::CGXDLMSData(std::string ln): CGXDLMSData(ln, 0) {
}
