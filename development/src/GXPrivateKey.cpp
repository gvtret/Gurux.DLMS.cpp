...
void CGXPrivateKey::SetSystemTitle(CGXByteBuffer &value) {
	m_SystemTitle = value;
}

int CGXPrivateKey::FromRawBytes(CGXByteBuffer &value, CGXPrivateKey &key) {
...
int CGXPrivateKey::UpdatePublicKey(CGXAsn1Sequence *seq, CGXPrivateKey &key) {
	int ret = 0;
...
int CGXPrivateKey::FromDer(std::string der, CGXPrivateKey &key) {
...
int CGXPrivateKey::FromPem(std::string pem, CGXPrivateKey &value) {
...
int CGXPrivateKey::Load(std::string &path, CGXPrivateKey &value) {
	std::string text;
