...
//Constructor.
CGXDLMSMBusSlavePortSetup::CGXDLMSMBusSlavePortSetup(): CGXDLMSMBusSlavePortSetup("", 0) {
}

//SN Constructor.
CGXDLMSMBusSlavePortSetup::CGXDLMSMBusSlavePortSetup(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_MBUS_SLAVE_PORT_SETUP, ln, sn) {
}

//LN Constructor.
CGXDLMSMBusSlavePortSetup::CGXDLMSMBusSlavePortSetup(std::string ln): CGXDLMSMBusSlavePortSetup(ln, 0) {
}
