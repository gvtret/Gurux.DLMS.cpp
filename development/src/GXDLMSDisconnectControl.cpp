...
//Constructor.
CGXDLMSDisconnectControl::CGXDLMSDisconnectControl(): CGXDLMSDisconnectControl("", 0) {
}
...
//LN Constructor.
CGXDLMSDisconnectControl::CGXDLMSDisconnectControl(std::string ln): CGXDLMSDisconnectControl(ln, 0) {
}
