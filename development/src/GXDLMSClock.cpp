...
CGXDLMSClock::CGXDLMSClock(): CGXDLMSClock("0.0.1.0.0.255", 0) {
}

CGXDLMSClock::CGXDLMSClock(std::string ln): CGXDLMSClock(ln, 0) {
}

CGXDLMSClock::CGXDLMSClock(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_CLOCK, ln, sn) {
