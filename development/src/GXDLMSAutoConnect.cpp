...
//Constructor.
CGXDLMSAutoConnect::CGXDLMSAutoConnect(): CGXDLMSAutoConnect("0.0.2.1.0.255", 0) {
}

//SN Constructor.
CGXDLMSAutoConnect::CGXDLMSAutoConnect(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_AUTO_CONNECT, ln, sn) {
...
//LN Constructor.
CGXDLMSAutoConnect::CGXDLMSAutoConnect(std::string ln): CGXDLMSAutoConnect(ln, 0) {
}
