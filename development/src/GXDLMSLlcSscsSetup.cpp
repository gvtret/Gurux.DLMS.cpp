...
//Constructor.
CGXDLMSLlcSscsSetup::CGXDLMSLlcSscsSetup(): CGXDLMSLlcSscsSetup("0.0.28.0.0.255", 0) {
}
...
//LN Constructor.
CGXDLMSLlcSscsSetup::CGXDLMSLlcSscsSetup(std::string ln): CGXDLMSLlcSscsSetup(ln, 0) {
}
