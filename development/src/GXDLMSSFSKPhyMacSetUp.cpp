...
//Constructor.
CGXDLMSSFSKPhyMacSetUp::CGXDLMSSFSKPhyMacSetUp(): CGXDLMSSFSKPhyMacSetUp("0.0.26.0.0.255", 0) {
}
...
//LN Constructor.
CGXDLMSSFSKPhyMacSetUp::CGXDLMSSFSKPhyMacSetUp(std::string ln): CGXDLMSSFSKPhyMacSetUp(ln, 0) {
}
