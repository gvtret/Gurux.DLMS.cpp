...
//Constructor.
CGXDLMSPrimeNbOfdmPlcMacSetup::CGXDLMSPrimeNbOfdmPlcMacSetup(): CGXDLMSPrimeNbOfdmPlcMacSetup("0.0.28.2.0.255", 0) {
}
...
//LN Constructor.
CGXDLMSPrimeNbOfdmPlcMacSetup::CGXDLMSPrimeNbOfdmPlcMacSetup(std::string ln): CGXDLMSPrimeNbOfdmPlcMacSetup(ln, 0) {
}
