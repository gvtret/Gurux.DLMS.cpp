...
//Constructor.
CGXDLMSSFSKReportingSystemList::CGXDLMSSFSKReportingSystemList(): CGXDLMSSFSKReportingSystemList("0.0.26.6.0.255", 0) {
}
...
//LN Constructor.
CGXDLMSSFSKReportingSystemList::CGXDLMSSFSKReportingSystemList(std::string ln): CGXDLMSSFSKReportingSystemList(ln, 0) {
}
