...
CGXDLMSMBusClient::CGXDLMSMBusClient(std::string ln): CGXDLMSMBusClient(ln, 0) {
}
...
int CGXDLMSMBusClient::SlaveInstall(CGXDLMSClient *client, std::vector<CGXByteBuffer> &reply) {
	CGXDLMSVariant data((char)0);
	return client->Method(this, 1, data, reply);
}

int CGXDLMSMBusClient::SlaveDeInstall(CGXDLMSClient *client, std::vector<CGXByteBuffer> &reply) {
	CGXDLMSVariant data((char)0);
	return client->Method(this, 2, data, reply);
}

int CGXDLMSMBusClient::Capture(CGXDLMSClient *client, std::vector<CGXByteBuffer> &reply) {
	CGXDLMSVariant data((char)0);
	return client->Method(this, 3, data, reply);
}

int CGXDLMSMBusClient::ResetAlarm(CGXDLMSClient *client, std::vector<CGXByteBuffer> &reply) {
	CGXDLMSVariant data((char)0);
	return client->Method(this, 4, data, reply);
}

int CGXDLMSMBusClient::SynchronizeClock(CGXDLMSClient *client, std::vector<CGXByteBuffer> &reply) {
	CGXDLMSVariant data((char)0);
