...
//Constructor.
CGXDLMSCredit::CGXDLMSCredit(): CGXDLMSCredit("", 0) {
}

//SN Constructor.
CGXDLMSCredit::CGXDLMSCredit(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_CREDIT, ln, sn) {
}

//LN Constructor.
CGXDLMSCredit::CGXDLMSCredit(std::string ln): CGXDLMSCredit(ln, 0) {
}
