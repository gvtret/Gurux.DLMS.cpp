...
//Constructor.
CGXDLMSSFSKMacCounters::CGXDLMSSFSKMacCounters(): CGXDLMSSFSKMacCounters("0.0.26.3.0.255", 0) {
}
...
//LN Constructor.
CGXDLMSSFSKMacCounters::CGXDLMSSFSKMacCounters(std::string ln): CGXDLMSSFSKMacCounters(ln, 0) {
