...
//Constructor.
CGXDLMSParameterMonitor::CGXDLMSParameterMonitor(): CGXDLMSParameterMonitor("0.0.16.2.0.255", 0) {
}
...
//LN Constructor.
CGXDLMSParameterMonitor::CGXDLMSParameterMonitor(std::string ln): CGXDLMSParameterMonitor(ln, 0) {
}
