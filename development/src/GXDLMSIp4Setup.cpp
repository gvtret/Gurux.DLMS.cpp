...
//Constructor.
CGXDLMSIp4Setup::CGXDLMSIp4Setup(): CGXDLMSIp4Setup("0.0.25.1.0.255", 0) {
}

//SN Constructor.
CGXDLMSIp4Setup::CGXDLMSIp4Setup(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_IP4_SETUP, ln, sn) {
    m_IPAddress = 0;
    m_SubnetMask = 0;
...
//LN Constructor.
CGXDLMSIp4Setup::CGXDLMSIp4Setup(std::string ln): CGXDLMSIp4Setup(ln, 0) {
}
