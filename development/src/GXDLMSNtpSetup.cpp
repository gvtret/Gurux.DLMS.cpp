...
//Constructor.
CGXDLMSNtpSetup::CGXDLMSNtpSetup(): CGXDLMSNtpSetup("0.0.25.10.0.255", 0) {
}

//SN Constructor.
CGXDLMSNtpSetup::CGXDLMSNtpSetup(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_NTP_SETUP, ln, sn) {
}

//LN Constructor.
CGXDLMSNtpSetup::CGXDLMSNtpSetup(std::string ln): CGXDLMSNtpSetup(ln, 0) {
}
