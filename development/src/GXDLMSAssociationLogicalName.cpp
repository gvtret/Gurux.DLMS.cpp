...
int CGXDLMSAssociationLogicalName::GetObjects(CGXDLMSSettings &settings, CGXDLMSValueEventArg &e, CGXByteBuffer &data) {
    int ret;
    unsigned long pos = 0;
...
// Returns user list
int CGXDLMSAssociationLogicalName::GetUsers(CGXDLMSSettings &settings, CGXDLMSValueEventArg &e, CGXByteBuffer &data) {
    unsigned long pos = 0;
    //Add count only for first time.
    if (settings.GetIndex() == 0) {
