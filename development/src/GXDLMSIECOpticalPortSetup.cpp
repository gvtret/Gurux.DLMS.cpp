...
//Constructor.
CGXDLMSIECLocalPortSetup::CGXDLMSIECLocalPortSetup(): CGXDLMSIECLocalPortSetup("0.0.20.0.0.255", 0) {
}
...
//LN Constructor.
CGXDLMSIECLocalPortSetup::CGXDLMSIECLocalPortSetup(std::string ln): CGXDLMSIECLocalPortSetup(ln, 0) {
}
