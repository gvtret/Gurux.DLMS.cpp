...
//Constructor.
CGXDLMSAccount::CGXDLMSAccount(): CGXDLMSAccount("", 0) {
}

//SN Constructor.
CGXDLMSAccount::CGXDLMSAccount(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_ACCOUNT, ln, sn) {
...
//LN Constructor.
CGXDLMSAccount::CGXDLMSAccount(std::string ln): CGXDLMSAccount(ln, 0) {
}
...
int CGXDLMSAccount::Activate(CGXDLMSClient *client, std::vector<CGXByteBuffer> &reply) {
    CGXDLMSVariant data((char)0);
    return client->Method(this, 1, data, reply);
}

int CGXDLMSAccount::Close(CGXDLMSClient *client, std::vector<CGXByteBuffer> &reply) {
    CGXDLMSVariant data((char)0);
    return client->Method(this, 2, data, reply);
}

int CGXDLMSAccount::Reset(CGXDLMSClient *client, std::vector<CGXByteBuffer> &reply) {
    CGXDLMSVariant data((char)0);
