...
//Constructor.
CGXDLMSIp6Setup::CGXDLMSIp6Setup(): CGXDLMSIp6Setup("0.0.25.7.0.255", 0) {
}

//SN Constructor.
CGXDLMSIp6Setup::CGXDLMSIp6Setup(std::string ln, unsigned short sn): CGXDLMSObject(DLMS_OBJECT_TYPE_IP6_SETUP, ln, sn) {
}

//LN Constructor.
CGXDLMSIp6Setup::CGXDLMSIp6Setup(std::string ln): CGXDLMSIp6Setup(ln, 0) {
}
