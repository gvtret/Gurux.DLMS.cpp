...
//Constructor.
CGXDLMSSpecialDaysTable::CGXDLMSSpecialDaysTable(): CGXDLMSSpecialDaysTable("", 0) {
}
...
//LN Constructor.
CGXDLMSSpecialDaysTable::CGXDLMSSpecialDaysTable(std::string ln): CGXDLMSSpecialDaysTable(ln, 0) {
}
