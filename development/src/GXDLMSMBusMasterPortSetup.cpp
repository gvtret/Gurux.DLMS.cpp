...
//Constructor.
CGXDLMSMBusMasterPortSetup::CGXDLMSMBusMasterPortSetup(): CGXDLMSMBusMasterPortSetup("", 0) {
}
...
//LN Constructor.
CGXDLMSMBusMasterPortSetup::CGXDLMSMBusMasterPortSetup(std::string ln): CGXDLMSMBusMasterPortSetup(ln, 0) {
}
