...
TEST_F(GXByteBufferTest, IndexedMultiByteGetters) {
    ...
    const uint8_t pattern[16] = {0xDE, 0xAD, 0xBE, 0xEF, 0xCA, 0xFE, 0xBA, 0xBE, 0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0};
...
TEST_F(GXByteBufferTest, FromBase64MultiBlockDecoding) {
    std::string base64 = "TWFuIGlzIGRpc3Rpbmd1aXNoZWQsIG5vdCBv\nbmx5IGJ5IGhpcyByZWFzb24=";
    ...
    std::string decoded(reinterpret_cast<const char *>(buffer.GetData()), buffer.GetSize());
